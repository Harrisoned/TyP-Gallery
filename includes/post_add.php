...
?>
	...
	<table><tr><td>
        <div style="margin-bottom: 2em;">
            ...
            <ul>
                ...
                <li>Our site is mainly furry related. <b>Stick to the status quo.</b></li>
                <li>You can upload whatever the fuck you want as long as it is furry related, just please, don't post gross stuff or anything that is forbidden under nacional law, like child pornography.</li>
	...
	<tr><td>
	Source:<br />
	<input type="text" name="source" value="" size="53" />
	</td></tr>
	<tr><td>
	Title:<br />
	<input type="text" name="title" value="" size="53" />
	</td></tr>
	<tr><td>
	Tags:<br />
	<textarea id="tags" name="tags" cols="60" rows="2" tabindex="3"></textarea><br />
    Separate tags with spaces. (ex: green_eyes purple green_hair)<br /><br />
	</td></tr>
	<tr><td>
	Rating:<br />
