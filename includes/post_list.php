    ...
    <div id="post-list">
        <div class="sidebar">
            <div class="sidebar2">
                <center>
                    <div class="sidebar3">
                        <center class="search_list">
                            <b>Search for images</b>
                            <img src="layout/icons/question-small-white.png" alt="Supports wildcards *" title="Supports wildcards (*) , negating tags (-) and fuzzy search (~)"/>
                        </center>
                        <form action="index.php?page=search" method="post">
                            <div>
                                <input id="tags" name="tags" class="search_list" type="text" value="<?php if(isset($_GET['tags']) && $_GET['tags'] != "all"){ print str_replace("%",'',str_replace("'","&#039;",str_replace('"','&quot;',$_GET['tags'])));}?>"/>
                                <br />
                                <input name="commit" class="secondary_search" type="submit" value="" />
                            </div>
                        </form>
                    </div>
                </center>
        ...
        <div id="blacklisted-sidebar" style="display: none; margin: 8px;">
            <center>
                <img src="layout/icons/exclamation-small.png" alt="alert" style="margin-top: -1px;" />
                <a id="pi" href="#" onclick="showHideIgnored('0','pi'); return false;"></a>
            </center>
        </div>
<div class="sidebar2 sidebar4">
    <center>
        <div class="sidebar3">
            <b style="font-size: 12px;">Tags</b><br /><br />
            <ul id="tag-sidebar">
<?php
